function indexPage(){
  ...
  <div className="navbar">
    <div className="logo">
      <img src="image/logo.png" alt="x" className="logo-nav" />
    </div>
    <div>
      <div className="nav-item">
        <a className="navbar-link" href="home.html">
          <svg
            viewBox="0 0 24 24"
            aria-hidden="true"
      ...
      <div className="nav-item">
        <a className="navbar-link" href="explore.html">
          <svg
            viewBox="0 0 24 24"
            aria-hidden="true"
            className="r-4qtqp9 r-yyyyoo r-dnmrzs r-bnwqim r-lrvibr r-m6rgpd r-18jsvk2 r-lwhw9o r-cnnz9e"
      ...
      <div className="nav-item">
        <a className="navbar-link" href="notifications.html">
          <svg
            viewBox="0 0 24 24"
            aria-hidden="true"
            className="r-4qtqp9 r-yyyyoo r-dnmrzs r-bnwqim r-lrvibr r-m6rgpd r-18jsvk2 r-lwhw9o r-cnnz9e"
      ...
      <div className="nav-item">
        <a className="navbar-link" href="follow.html">
          <svg
            viewBox="0 0 24 24"
            aria-hidden="true"
            className="r-4qtqp9 r-yyyyoo r-dnmrzs r-bnwqim r-lrvibr r-m6rgpd r-18jsvk2 r-lwhw9o r-cnnz9e"
      ...
      <div className="nav-item">
        <a className="navbar-link" href="chat.html">
          <svg
            viewBox="0 0 24 24"
            aria-hidden="true"
            className="r-4qtqp9 r-yyyyoo r-dnmrzs r-bnwqim r-lrvibr r-m6rgpd r-18jsvk2 r-lwhw9o r-cnnz9e"
      ...
      <div className="nav-item">
        <a className="navbar-link" href="grok.html">
          <svg
            viewBox="0 0 33 32"
            aria-hidden="true"
            className="r-4qtqp9 r-yyyyoo r-dnmrzs r-bnwqim r-lrvibr r-m6rgpd r-18jsvk2 r-lwhw9o r-cnnz9e"
      ...
      <div className="nav-item">
        <a className="navbar-link" href="more.html">
          <svg
            viewBox="0 0 24 24"
            aria-hidden="true"
            className="r-4qtqp9 r-yyyyoo r-dnmrzs r-bnwqim r-lrvibr r-m6rgpd r-18jsvk2 r-lwhw9o r-cnnz9e"
    ...
    <div className="bottom-profile">
      <div className="">
        <img className="profile-pic" src="image/profile.jpg" alt="pic" />
      </div>
      <div className="">
        <span>sandip kumar mahto</span>
        <span>@sandipkm1</span>
      </div>
      <div className="">⋮</div>
      <span></span>
